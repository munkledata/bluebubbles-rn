...
const DRIVER_SELF_TEST_MIGRATION_COUNT = 42 as const;
...
const DB_RUNTIME_CONCURRENCY_SELF_TEST_MIGRATION_COUNT = 42 as const;
const DB_RUNTIME_CONCURRENCY_SELF_TEST_MIGRATION_HEAD = '0042_message_part_identity' as const;
...
const DB_PROCESS_RELAUNCH_SELF_TEST_MIGRATION_COUNT = 42 as const;
const DB_PROCESS_RELAUNCH_SELF_TEST_MIGRATION_HEAD = '0042_message_part_identity' as const;
...
const DB_ACTIVE_MIGRATION_DEATH_HEAD = '0042_message_part_identity' as const;
const DB_ACTIVE_MIGRATION_DEATH_MIGRATION_COUNT = 42 as const;
