...
test('certifies exactly the reviewed send front-door delegation edges', () => {
  ...
  assert.equal(sendFrontDoorFindings.length, 21);
});
...
test('certifies exactly the reviewed attachment-download delegation boundary', () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      'src/ui/attachments/ContactCard.tsx#ContactCard.onPress.<callback:7e05943cca>:mutator-call:146cb546ae54',
      'src/ui/attachments/ContactCard.tsx#ContactCard.onPress:mutator-call:1f8dbbc4c7e6',
      'src/ui/attachments/ContactCard.tsx#ContactCard.onPress:mutator-call:8cff34032627',
      'src/ui/attachments/ContactCard.tsx#ContactCard:mutator-reference:6f03b1e5f758',
      'src/ui/attachments/FileChip.tsx#FileChip.onPress.<callback:ac414c7708>:mutator-call:df77301145b2',
      'src/ui/attachments/FileChip.tsx#FileChip.onPress:mutator-call:4e92d0a9dbcb',
...
test('certifies exactly the reviewed repository-context and thin-delegation boundary', () => {
  ...
  assert.deepEqual(
    ...
    [
      ...
      'src/features/facetime/useFaceTime.ts#useFaceTime.<callback:6e437cf5bf>:mutator-call:e7c2d4225f13',
