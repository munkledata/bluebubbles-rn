  ...
  return (
    <Screen>
      ...
      >
        ...
        <Text style={[styles.title, { color: theme.color.label }]}>FaceTime</Text>
        <View style={{ width: 50 }} />
      </View>
      ...
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
          ...
          {(
            ...
            <Pressable
              ...
              style={[
                ...
                {
                  backgroundColor:
                    video === v ? theme.color.tint : theme.color.secondaryBackground,
                },
              ]}
            >
        ...
        >
          <Text
            style={[styles.callText, { color: canCall ? '#fff' : theme.color.tertiaryLabel }]}
          >
            📹 FaceTime
          </Text>
        </Pressable>
