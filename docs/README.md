...
- [`DEVICE_VERIFICATION_CHECKLIST.md`](./DEVICE_VERIFICATION_CHECKLIST.md) records device-only evidence. A checked
  shared device step closes a task only when the work plan says it does.
...
| Active database-write handoff | [`DB_02A_CURRENT.md`](./DB_02A_CURRENT.md) |
